...
function Notification({ setIsNotificationOpen }) {
  return (
    <>
      {" "}
      <div className="fixed backdrop:blur-md space-y-3 right-10 top-12 w-[300px] bg-white shadow-xl transition ease-in-out duration-500 rounded-lg p-4 z-50">
        <div className="">

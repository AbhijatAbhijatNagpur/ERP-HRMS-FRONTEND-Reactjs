          ...
          <div className="flex flex-col bg-white py-5 px-5 rounded-xl shadow-md">
            ...
            <div className=" space-x-3 mt-5">
              <button
                ...
                className="bg-gray-200 text-black px-2 py-1 text-xs rounded-xl"
              >
                Previous
              </button>
              <button
                ...
                className="bg-blue-200 text-black px-2 py-1 text-xs rounded-xl"
              >
                Next
              </button>
              <span className="text-md text-xs font-semibold">
                Page{" "}
                <span className="bg-gray-400 px-5 text-xs rounded-md">
                  {currentPage}
                </span>{" "}
                of {totalPages}
                <span className="bg-gray-200 text-xs px-5 rounded-md mx-3">
                  {totalPages}
                </span>
              </span>
            </div>

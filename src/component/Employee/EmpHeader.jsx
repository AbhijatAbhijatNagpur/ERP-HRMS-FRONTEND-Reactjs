...
import Notification from "../Surgisol/DashboardCompo/Model/Notification"; // Import the notification component
function EmpHeader({ openside }) {
  ...
  return (
    <>
      ...
      {/* Notification Modal */}
      {isNotificationOpen && <Notification onClick={setIsNotificationOpen} />}
    </>
  );
}
